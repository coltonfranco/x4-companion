...
# (see x4_api/__main__.py). onedir avoids per-launch temp extraction — faster start,
...
entry = str(spec_dir / "src" / "x4_api" / "__main__.py")
...
hiddenimports = [
    ...
    "networkx",
    "typer",
    "uvicorn",  # imported inside a function in __main__.py
    ...
    *collect_submodules("uvicorn"),
    ...
    # uvicorn loads "x4_api.server:app" from a string so PyInstaller can't
    # trace it.
