...
Patterns:
    ...
    * Hand-crafted tiny XML/save fixtures in `fixtures/` exercise the extractors. Real
      X4 saves are too big and license-encumbered to commit; use golden-fixture
      extracts for cross-version regression instead.
"""
