        ...
        out.gamestarts.append(
            {
                ...
                "universe_visitors": 0
                if universe_el is not None and universe_el.get("visitors") == "false"
                else 1,
                "universe_online_inventory": 0
                if universe_el is not None and universe_el.get("onlineinventory") == "false"
                else 1,
                "jobs_enabled": 0
                if jobs_el is not None and jobs_el.get("enabled") == "false"
                else 1,
                "god_enabled": 0 if god_el is not None and god_el.get("enabled") == "false" else 1,
                "masstraffic_enabled": 0
                if mt_el is not None and mt_el.get("enabled") == "false"
                else 1,
            }
        )
